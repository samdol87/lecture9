...
class Song(object):
    ...
    def __str__(self):
        print_format = "{} by {} on {} whose URL is {}"
        return print_format.format(self.track, self.artist,
                                   self.album, self.track_url)
    ...
    def open_url_for_track(self):
        if self.track_url:
            ...
            print_format = "Sorry, no such URL for this song: {}"
            print(print_format.format(self.track))

...
class Card(object):
    ...
    def __init__(self, suit=0, rank=2):
        ...
        # self.rank handles printed representation
        if rank in self.faces:
            self.rank = self.faces[rank]
        else:
            self.rank = rank
        # To handle winning comparison
        self.rank_num = rank
...
class Deck(object):
    # Don't need any input to create a deck of cards
    def __init__(self):
...
# /id495954957?i=495955054&uo=4" doesn’t understand
# the “open location” message. (-1708)
